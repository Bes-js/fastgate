type Protocol = 'socks4' | 'socks5' | 'http';
type Format = 'json' | 'text' | 'csv';
type Anonymity = 'Elite' | 'Anonymous' | 'Transparent';
type ProxyFormat = 'protocolipport' | 'ipport';
...
export type { Anonymity, Country, Format, OmitedProxyAPIResponse, Protocol, ProxyAPIOptions, ProxyAPIResponse, ProxyFetchOptions, ProxyFilterOptions, ProxyFormat, ProxyObject };
